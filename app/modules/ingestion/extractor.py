...
try:
    if settings.GEMINI_API_KEY:
        ...
        log.info("Ingestion AI Extractor configured successfully with Gemini 2.5 Flash.")
    else:
...
def extract_data_from_file(file_content: bytes, file_mime_type: str, prompt: str) -> Optional[Dict[str, Any]]:
    """
