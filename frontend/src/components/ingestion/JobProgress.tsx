        ...
        <Card className="mt-6">
            ...
            <CardContent className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500">Started at: {job.created_at.toLocaleString()}</p>
                    {job.completed_at && (
                        <p className="text-sm text-gray-500">Completed at: {job.completed_at.toLocaleString()}</p>
                    )}
                </div>
            </CardContent>
        </Card>
